...
const hardcodedLayers: GeospatialLayer[] = [
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/fa797f4cf1e5ce225a72f02af404d905-c080006b9bb52d101eaa61b70c122a06/tiles/{z}/{x}/{y}',
    description:
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/5ea431de2de6e6c83711a1b6a2b37bc7-b7c0b5fd652b92c61c092c443bb2f0b9/tiles/{z}/{x}/{y}',
    description:
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/2b3a008fcf83f0eae359b79de16e5efe-aa2fa3253e159dc529b1c61b42ca9a98/tiles/{z}/{x}/{y}',
    description:
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/a21beda622e83dced1ecc3a681cb9927-f26cfa3db8c696d71cd5ffd8109b6d3b/tiles/{z}/{x}/{y}',
    description:
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/1e27888f9370ec8efd9f7080b4a3c72a-1f7e46a2080751d4cb2f6f84849d5621/tiles/{z}/{x}/{y}',
    description:
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/83536c022210398f7691e1a6fa98cf2a-a939dfa7afc8f59a08b7e23a11725303/tiles/{z}/{x}/{y}',
    description:
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/6a915b6d07bfa6c85d6563c72417f55d-06ba6e80d194745d7e97e1c041f286b0/tiles/{z}/{x}/{y}',
    category: 'biodiversity related data layers',
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/b1657894ff8cf3f0f7b4f99823cd7645-79697882c7f6a1fb33d25208cb9422df/tiles/{z}/{x}/{y}',
    category: 'biodiversity related data layers',
    description: 'Jenkins et al (2013)',
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/8b61aa4552f4cd0c7fba3c4101357b77-b1f8b785f9f5dcc0764ca4ebe398f249/tiles/{z}/{x}/{y}',
    category: 'biodiversity related data layers',
    description: 'Jenkins et al (2013)',
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/79610241108ffa77a3fbf492ffef7940-045df24005945836a817ca33fa3527f3/tiles/{z}/{x}/{y}',
  ...
  },
  {
    ...
    category: 'land cover related data layers',
    description:
      'Bastin et al (2019). This resource contains information about which areas of the planet could theoretically support tree cover, based on prevailing environmental conditions. The resulting map reveals Earth’s full tree cover capacity at a spatial resolution ~1km. When areas currently supporting tree cover or occupied by croplands and human settlements are subtracted, it also provides a global map of areas theoretically available for tree cover restoration.',
  },
  {
    name: 'Wetlands',
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/5689875196a1219d0894bf127fcf8d95-517f5777ec04897ba9b41ffdd828a194/tiles/{z}/{x}/{y}',
    description:
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/51cc0b112519719762ac4df87f783c82-f902332ae1691694f243174e13951aa2/tiles/{z}/{x}/{y}',
    category: 'water related data layers',
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/734539289b8317f08db3ea9c57f79c29-aee1b26236e605a1afab8a94090b851f/tiles/{z}/{x}/{y}',
    description:
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint:
      'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/08ff5c66dc2354c8ba5a6cac9ca36870-cd498cf2eb5ca9fa0b6ed951a0cd062d/tiles/{z}/{x}/{y}',
    description:
