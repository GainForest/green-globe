const hardcodedLayers: GeospatialLayer[] = [
  ...
  },
  {
    ...
    description:
      'Data layer of current mean carbon density in above ground woody biomass',
    category: 'carbon related data layers',
  },
  {
    ...
    description: "Data layer of current mean carbon density in below ground woody biomass",
    category: "carbon related data layers"
  },
  {
    ...
    description: "Data layer of current mean density of soil organic carbon",
    category: "carbon related data layers"
  },
  {
    ...
    description: "Data layer of potential mean carbon density in above ground woody biomass",
    category: "carbon related data layers"
  },
  {
    ...
    description: "Data layer of potential mean carbon density in below ground woody biomass",
    category: "carbon related data layers"
  },
  {
    ...
    description: "Data layer of potential mean density of soil organic carbon",
    category: "carbon related data layers"
  },
  {
    ...
    description: "Mean annual Net Primary Productivity for the years 2001–2019 (inclusive).",
    category: "carbon related data layers"
  },
  {
  ...
  },
  {
    ...
    description: "Map of global wetland prevalence. Shows absence of wetlands (0) or presence of four different kinds.",
    category: "land cover related data layers"
  },
  {
  ...
  },
  {
    ...
    description: "Data layer of an aridity (i.e. dryness) metric at 30 arc second resolution. Here, Aridity Index (AI) is defined as Mean Annual Precipitation / Mean Annual Evapotranspiration",
    category: "environment related data layers"
  },
  {
    name: "Elevation",
    ...
    description: "High-resolution digital elevation model with global coverage.",
    category: "environment related data layers"
  },
  {
