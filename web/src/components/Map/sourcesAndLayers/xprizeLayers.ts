...
const hardcodedLayers: GeospatialLayer[] = [
  {
  ...
  },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/a2b0f58bcf25eecaca86b49ea36b08f9-0fe8ae80f3bc89b5bebb9f1fbf12ef3e/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/ac40136bfe92501e6ca9261828925ac9-b46bee21d8baece64621717cba262873/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/c46da94543333e1232b2c14ab8a6b777-3c87cba7479cf56ad2c2de31663404f6/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/fa797f4cf1e5ce225a72f02af404d905-db396a182801d5befb2046788f04edf8/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/5ea431de2de6e6c83711a1b6a2b37bc7-5488c7bbb3b6fdb2cde2acdd776a29bc/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/2b3a008fcf83f0eae359b79de16e5efe-36c43c69aaa7935e4318819015bf3af5/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/a21beda622e83dced1ecc3a681cb9927-2f43cc18f8f6e4eda6345642c4270461/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/1e27888f9370ec8efd9f7080b4a3c72a-bb51d021ed3c8687e64392ac43db3890/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/6098c1aff307dcd4f40af6932979ba63-ec747a0b90176d32b618e1368b82476b/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/b28ea9733a2e920a4f92001e8f2881f5-1f952da0faebc16a352e523ea401412b/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/b1657894ff8cf3f0f7b4f99823cd7645-5e62624e6142ef9544f18c244516ed78/tiles/{z}/{x}/{y}',
      category: 'biodiversity related data layers',
      description: 'Jenkins et al (2013)',
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/8b61aa4552f4cd0c7fba3c4101357b77-23768a508434adc71b2c910996cc2ee3/tiles/{z}/{x}/{y}',
      category: 'biodiversity related data layers',
      description: 'Jenkins et al (2013)',
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/79610241108ffa77a3fbf492ffef7940-9188cc42a5569dd149e8180de8bf0139/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/1a5b8e6c753abc03057f6e9dac95f437-8adfe48e4f54af23389c7760daf45e97/tiles/{z}/{x}/{y}',
      category: 'land cover related data layers',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/a1f192b54ff7e80ec7bd0e0f163a2331-f48402cf93a991c19fd30de116ae64e6/tiles/{z}/{x}/{y}',
      category: 'land cover related data layers',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/61656cc4ddd685befa6e87be32c46ac8-37982807fcd2395219cb6e986f42a78e/tiles/{z}/{x}/{y}',
      category: 'land cover related data layers',
    ...
    },
    {
      name: 'Wetlands',
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/5689875196a1219d0894bf127fcf8d95-77245e96cf06d9cbc08c3fabcf0d8c0d/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/06c576906eb5958ce74f8e75d490071b-33bd683fb3c689c2d4be5a98b942dbb4/tiles/{z}/{x}/{y}',
    ...
    },
    {
      name: 'Depth to Water',
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/51cc0b112519719762ac4df87f783c82-059a9b503e61d85b8f6464537f5ef461/tiles/{z}/{x}/{y}',
      category: 'water related data layers',
    ...
    },
    {
      name: 'Soil PH',
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/002161bbe9484ced930786c91ce240cb-160b6d4bbc4cd8511c4db248d7e38d5a/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/b44bc50a4ca22ddd5b0e761bc8f10db2-2b79d6f30d3a7c4bf57ef64f55a083c5/tiles/{z}/{x}/{y}',
      category: 'environment related data layers',
    ...
    },
    {
      name: 'Aridity Index',
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/734539289b8317f08db3ea9c57f79c29-18968c153e00592bc403dee11fb193aa/tiles/{z}/{x}/{y}',
    ...
    },
    {
      ...
      type: 'raster_tif',
      endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/7a5e5a6cbaae392790f5dc919e875b16-4c2b2204f6b6f71bbef0e0b45a8034e8/tiles/{z}/{x}/{y}',
      category: 'environment related data layers',
      description: 'Schiavina et al (2019). Maximum population count is capped at 3000 people in pixel (saturation)',
    },
    {name: 'Elevation',
    type: 'raster_tif',
    endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/08ff5c66dc2354c8ba5a6cac9ca36870-c042ab4f477a7388421fe9de804ec89b/tiles/{z}/{x}/{y}',
  ...
  },
  {
    ...
    type: 'raster_tif',
    endpoint: 'https://earthengine.googleapis.com/v1alpha/projects/earthengine-legacy/maps/4f0a229d75c380f0d7f8e5f13304ab42-2b325d544c3a1ac3d270ae705ab2e5b1/tiles/{z}/{x}/{y}',
    category: 'environment related data layers',
